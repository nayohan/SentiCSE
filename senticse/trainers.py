...
class CLTrainer(Trainer):
    def __init__(self, model_path="model", **kwargs):
    ...
    def evaluate(
        ...
        params = {'task_path': PATH_TO_DATA, 'usepytorch': True, 'kfold': 5, 'model_path':self.model_path}
        params['classifier'] = {'nhid': 0, 'optim': 'rmsprop', 'batch_size': 128,
                                            'tenacity': 3, 'epoch_size': 2}

        # params = {'task_path': PATH_TO_DATA, 'usepytorch': True, 'kfold': 10, 'model_path':self.model_path}
    ...
    def train(self, model_path: Optional[str] = None, trial: Union["optuna.Trial", Dict[str, Any]] = None):
        ...
        if self.model_init is not None:
            ...
            self.optimizer, self.lr_scheduler = None, True
